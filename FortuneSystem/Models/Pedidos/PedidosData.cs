...
namespace FortuneSystem.Models.Pedidos
{
    public class PedidosData
    {
        ...
        public IEnumerable<OrdenesCompra> ListaOrdenCompraWIP(int estadoTab)
        {
            ...
            try
            {
                ...
                while (leer.Read())
                {
                    ...
                    //Price tickets
                    pedidos.InfoPriceTickets = ObtenerTotalPriceTicketsTrims(infSummary.IdItems);
        ...
        public Trim_requests ObtenerTotalTrims(int? idSummary)
        {
            ...
            try
            {
                ...
                com.CommandText = "SELECT TR.id_request, TR.restante FROM trim_requests TR " +
                    ...
                    "WHERE TR.id_po_summary= '" + idSummary + "' and IC.fabric_type !='PRICE TICKETS' ";
                com.CommandType = CommandType.Text;
        ...
        //Obtener Información de trims por IdSummary
        public IEnumerable<Trim_requests>  ObtenerInformacionTrims(int? idSummary)
        {
            Conexion conexion = new Conexion();
        ...
        public IEnumerable<InfoPriceTickets> ObtenerInformacionPriceTicketsTrims(int? idSummary)
        {
            Conexion conexion = new Conexion();
