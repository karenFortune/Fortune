...
function TablaTrims(IdSum) {
    var IdSummary = parseInt(IdSum);
    var actionData = "{'idSummary':'" + IdSummary + "'}";
    $.ajax({
...
function TablaPriceTicketsTrims(IdSum) {
    var IdSummary = parseInt(IdSum);
    var actionData = "{'idSummary':'" + IdSummary + "'}";
    $.ajax({
                    ...
                    if (e.key.Trims.fecha_recibo !== null) {
                        popupTrims.option("contentTemplate",
                            function (contentElement) {
                                ...
                                IdPed = e.key.IdPedido;
                                IdEst = e.key.IdEstilo;
                                var tablaTrims = TablaTrims(IdSum);
                    ...
                    if (e.key.Trims.fecha_recibo !== null) {
                        popupPriceTrims.option("contentTemplate",
                            function (contentElement) {
                                ...
                                IdPed = e.key.IdPedido;
                                IdEst = e.key.IdEstilo;
                                var tablaPriceTrims = TablaPriceTicketsTrims(IdSum);
