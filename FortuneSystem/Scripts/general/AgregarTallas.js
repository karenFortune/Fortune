$(document).ready(function () {
    ...
    $(document).on("click", ".classAdd", function () {
        ...
        var tallasdiv = '<tr class="data-Talla">' +
            ...
            '<td><input type="text" id="l-cantidad" name="l-cantidad" class="form-control l-name01 numCantTall"  /></td>' +
            '<td><input type="text" id="e-extras"  name="e-extras" class="form-control e-name01 numExtTall" value="' + 0 + '"/></td>' +
            '<td><input type="text" id="s-ejemplo" name="s-ejemplo" class="form-control s-name01 numEjmTall" value="' + 0 + '"/></td>' +
